...
@push('css')
    <style>
        /* Contacts Page Background - Matching Chatbot Theme */
...
@section('content')
    ...
    <div class="rocket-stars-background" id="rocket-stars-contacts"></div>
...
@push('script')
    <script>
        // Interactive Stars Background for Contacts Page
        let contactsStars = [];
        let contactsMouseX = 0;
        let contactsMouseY = 0;
        
        function createContactsStars() {
            const starsContainer = document.getElementById('rocket-stars-contacts');
            ...
            document.addEventListener('mousemove', function(e) {
                ...
                contactsMouseX = ((e.clientX - rect.left) / rect.width) * 100;
                contactsMouseY = ((e.clientY - rect.top) / rect.height) * 100;
        ...
        function updateContactsStars() {
            contactsStars.forEach(star => {
                const starX = parseFloat(star.dataset.x);
                const starY = parseFloat(star.dataset.y);
                
                // Calculate distance from mouse
                const dx = contactsMouseX - starX;
                const dy = contactsMouseY - starY;
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', createContactsStars);
        } else {
            createContactsStars();
        }
    </script>
