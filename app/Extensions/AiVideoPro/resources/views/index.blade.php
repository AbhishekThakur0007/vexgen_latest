        ...
        >
            ...
            >
                ...
                <div
					...
					x-show="['klingImage', 'klingV21', 'sora'].includes(selectedAction)"
                    x-cloak
                ...
                >
					<template x-if="selectedAction === 'sora'">
						<label class="text-xs text-foreground">
							{{ __('Reference Image (optional) — must match the requested width and height') }} <x-info-tooltip text="{{ __('The size must be one of the following: 720x1280, 1280x720, 1024x1792, 1792x1024') }}" />
						</label>
					</template>
