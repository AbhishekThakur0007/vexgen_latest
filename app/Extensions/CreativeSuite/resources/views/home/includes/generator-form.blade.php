@push('css')
    <style>
        /* Creative Suite Generator Form Styling - Matching Dashboard Theme */
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form-wrap {
            position: relative;
            z-index: 1;
        }
        
        /* Heading Styling - Gradient Text with Glow */
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form-wrap h1 {
        ...
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form-wrap h1 span {
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
            opacity: 0.7;
        ...
        /* Form Styling */
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form {
        ...
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form:hover {
            border-color: rgba(0, 212, 255, 0.4) !important;
            box-shadow: 0 12px 40px rgba(0, 0, 0, 0.4), 0 0 30px rgba(0, 212, 255, 0.2) !important;
        }
        
        /* Input Styling */
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form input,
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form select {
            background: transparent !important;
            color: rgba(255, 255, 255, 0.9) !important;
        }
        
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form input::placeholder {
            color: rgba(255, 255, 255, 0.5) !important;
        }
        
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form select option {
            background: linear-gradient(135deg, rgba(10, 14, 39, 0.98) 0%, rgba(26, 29, 58, 0.98) 50%, rgba(15, 23, 41, 0.98) 100%) !important;
            color: rgba(255, 255, 255, 0.9) !important;
        }
        
        /* Border Styling */
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form [class*="border-e"],
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form [class*="border"] {
            border-color: rgba(0, 212, 255, 0.2) !important;
        }
        
        /* Button Styling */
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form button[type="submit"] {
        ...
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form button[type="submit"]:hover {
            background: linear-gradient(135deg, rgba(0, 212, 255, 0.5), rgba(123, 47, 247, 0.5)) !important;
        ...
        /* Link Button Styling */
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form a,
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form button[variant="link"] {
            color: rgba(0, 212, 255, 0.9) !important;
        }
        
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form a:hover,
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form button[variant="link"]:hover {
            color: rgba(0, 212, 255, 1) !important;
        }
        
        /* Icon Button Styling */
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form button[variant="none"] {
            color: rgba(255, 255, 255, 0.7) !important;
        }
        
        body[data-theme="marketing-bot-dashboard"] .lqd-adv-img-editor-form button[variant="none"]:hover {
            color: rgba(0, 212, 255, 0.9) !important;
            transform: scale(1.1);
        }
