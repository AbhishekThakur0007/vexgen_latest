<style>
	...
	.platform-button-modern .lqd-icon,
	.platform-button-modern svg,
	.next-button-modern .lqd-icon,
	.next-button-modern svg {
		filter: drop-shadow(0 0 8px rgba(0, 212, 255, 0.6));
		transition: all 0.3s ease;
	}

	.platform-button-modern:hover .lqd-icon,
	.platform-button-modern:hover svg,
	.next-button-modern:hover .lqd-icon,
	.next-button-modern:hover svg {
