...
Route::middleware('auth:api')->group(function () {
    ...
    Route::prefix('xp')->group(function () {
        Route::get('/notifications', 'App\Http\Controllers\API\XPNotificationController@getPending');
        Route::post('/notifications/shown', 'App\Http\Controllers\API\XPNotificationController@markAsShown');
        Route::post('/notifications/dismissed', 'App\Http\Controllers\API\XPNotificationController@markAsDismissed');
        Route::get('/total', 'App\Http\Controllers\API\XPNotificationController@getTotalXP');
    });
});
