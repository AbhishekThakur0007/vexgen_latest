    ...
    ->group(static function () {
        ...
        Route::prefix('user')
            ...
            ->group(callback: function () {
                ...
                // XP Notification Routes
                Route::prefix('xp')->name('xp.')->group(function () {
                    Route::get('/notifications', [\App\Http\Controllers\API\XPNotificationController::class, 'getPending'])->name('notifications');
                    Route::post('/notifications/shown', [\App\Http\Controllers\API\XPNotificationController::class, 'markAsShown'])->name('notifications.shown');
                    Route::post('/notifications/dismissed', [\App\Http\Controllers\API\XPNotificationController::class, 'markAsDismissed'])->name('notifications.dismissed');
                    Route::get('/total', [\App\Http\Controllers\API\XPNotificationController::class, 'getTotalXP'])->name('total');
                });
