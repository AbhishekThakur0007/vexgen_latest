{{-- Videos List --}}
<div
    class="py-14 influencer-videos-list"
    x-data="exportedVideoData"
>
    <h2 class="mb-9 text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-purple-500 to-green-400">
        @lang('My Videos')
    </h2>
    ...
    <div class="grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
        <template x-for="video in exportedVideos">
            <template x-if="checkExtensionsStatus(video)">
                <div class="flex flex-col overflow-hidden rounded-xl border influencer-video-card">
